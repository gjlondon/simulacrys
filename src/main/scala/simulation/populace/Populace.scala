package simulation.populace

import simulation.message.Mailbox
import simulation.message.MailboxTypes.Mailbox
import org.joda.time.DateTime
import simulation.person.{Commoner, Person}
import simulation.status.Dead
