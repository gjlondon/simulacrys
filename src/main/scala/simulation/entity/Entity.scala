...
import simulation.message.MailboxTypes.{Inbox, Outbox}
...
/** base trait for any "object" in the simulation.world that is capable of acting or being acted on
  * e.g. people, animals, chairs.
  *
  * Each will have a mailbox where they receive incoming messages which they will
  * process and respond to before taking an "voluntary" simulation.actions
  */
trait Entity {
  ...
  /** resolve involuntary simulation.actions
    *
    * @param time
    * @param location
    * @param entity
