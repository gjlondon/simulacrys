...
sealed trait Location {
  def overview: String = {
    s"Location $name of type ${this.getClass.getSimpleName} has a living com.thrive.simulation.populace of size ${this.livingPopSize}"
  }
